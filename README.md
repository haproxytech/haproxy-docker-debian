...
-\t[`2.2-dev4`, `2.2`](https://github.com/haproxytech/haproxy-docker-debian/blob/master/2.2/Dockerfile)
-\t[`2.1.3`, `2.1`](https://github.com/haproxytech/haproxy-docker-debian/blob/master/2.1/Dockerfile)
-\t[`2.0.13`, `2.0`, `latest`](https://github.com/haproxytech/haproxy-docker-debian/blob/master/2.0/Dockerfile)
-\t[`1.9.14`, `1.9`](https://github.com/haproxytech/haproxy-docker-debian/blob/master/1.9/Dockerfile)
-\t[`1.8.24`, `1.8`](https://github.com/haproxytech/haproxy-docker-debian/blob/master/1.8/Dockerfile)
