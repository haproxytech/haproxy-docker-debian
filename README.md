...
-	[`3.3.15`, `s6-3.3.15`, `3.3`, `s6-3.3`](https://github.com/haproxytech/haproxy-docker-debian/blob/main/3.3/Dockerfile)
-	[`3.2.24`, `s6-3.2.24`, `3.2`, `s6-3.2`](https://github.com/haproxytech/haproxy-docker-debian/blob/main/3.2/Dockerfile)
-	[`3.0.28`, `s6-3.0.28`, `3.0`, `s6-3.0`](https://github.com/haproxytech/haproxy-docker-debian/blob/main/3.0/Dockerfile)
...
$ docker run -d --name my-running-haproxy --read-only \
    ...
    haproxytech/haproxy-debian:s6-3.4
```
...
```console
$ docker create --name haproxy-defaults haproxytech/haproxy-debian:s6-3.4
